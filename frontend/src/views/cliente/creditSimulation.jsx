...
export default function creditSimulation() {
    ...
    const handleSimulation = (e) => {
        e.preventDefault();
        history.push(`/cliente/calculoCredito?creditValue=${creditValue}&paymentMonths=${paymentMonths}&ufValue=${ufValue}`);
    };
        ...
        <div className="container mt-4">
            ...
            <form onSubmit={handleSimulation}>
                <div className="form-group">
                    <label htmlFor="valor">Valor del crédito a pedir (CLP)</label>
                    <input 
                        type="number" 
